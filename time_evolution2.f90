program main
  ...
  & zeta, zeta0, time, L, Pex, P0, Tinstant, Pinstant, deltar, rho,&
  ...
  open(11, file = 'position, momentum, M=0.001, Nstep=50000, iteration=100, alpha=0.001, r_cutoff=2.5, theta42(16), KBT0=1.5,1(3).dat')
  open(12, file = 'L, zeta, eta, s, PV, V, M=0.001, Nstep=50000, iteration=100, alpha=0.001, r_cutoff=2.5, theta42(16), KBT0=1.5,1(3).dat')
  open(13, file = 'time, Pinstant, Tinstant, V, PV, eta, M=0.001, Nstep=50000, iteration=100, alpha=0.001, r_cutoff=2.5, theta42(16),&
  &KBT0=1.5,1(3).dat')
  open(14, file = 'hamiltonian, M=0.001, Nstep=50000, iteration=100, alpha=0.001, r_cutoff=2.5, theta42(16), KBT0=1.5,1(3).dat')
  open(15, file = 'g_of_r, M=0.001, Nstep=50000, iteration=100, alpha=0.001, r_cutoff=2.5, theta42(16), KBT0=1.5,1(3).dat')
  open(16, file = 'vpair, M=0.001, Nstep=50000, iteration=100, alpha=0.001, r_cutoff=2.5, theta42(16), KBT0=1.5,1(3).dat')
  open(17, file = 'nabra_theta_u, M=0.001, Nstep=50000, iteration=100, alpha=0.001, r_cutoff=2.5, theta42(16), KBT0=1.5,1(3).dat')
  open(18, file = 'bcc_theta24.txt')
  open(19, file = 'integrate_gr')
  open(20, file = 'theta, M=0.001, Nstep=50000, iteration=100, alpha=0.001, r_cutoff=2.5, theta42(16), KBT0=1.5,1(3).dat')
  open(21, file = 'randp_NVT_KBT1.5_N1000.txt', action = 'read')
  !open(21, file = 'random_position1000.txt', action = 'read')
  open(22, file = 'error_integral, M=0.001, Nstep=50000, iteration=100, alpha=0.001, r_cutoff=2.5, theta42(16), KBT0=1.5,1(3).dat')
  ...
  theta = [0.867*0.95, 177.2*1.05, 0.168*1.05, 0.591*1.05]!rcut=2.5でBCCが得られる値からずらす
...
!write(*, *) dtheta
    ...
    if((j == 1).or.(mod(j, max(1, int(iteration/100)))==0))then
      write(20, '(i8, 8g26.16)') j, theta, dtheta
      do i = 1, 200
        r = 1+5._wp*i/200
        write(16, *) r, vpair_cut(r, theta, r_cutoff, v_cutoff)
        write(17, *) r, nabla_theta_u(r, theta, r_cutoff)
